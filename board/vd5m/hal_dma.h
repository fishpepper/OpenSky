...
extern __xdata HAL_DMA_DESC dma_config[5];

#define HAL_DMA_VLEN_USE_LEN                       0x00      // Use LEN for transfer count
#define HAL_DMA_VLEN_FIRST_BYTE_P_1                0x01      // Transfer the number of bytes specified by the first byte +1
#define HAL_DMA_VLEN_FIRST_BYTE                    0x02      // Transfer the number of bytes indicated by the first byte (itself included)
#define HAL_DMA_VLEN_FIRST_BYTE_P_2                0x03      // Transfer the number of bytes specified by the first byte +2
#define HAL_DMA_VLEN_FIRST_BYTE_P_3                0x04      // Transfer the number of bytes specified by the first byte +3
#define HAL_DMA_LEN_MAX                            0xFF      // The maximum length is always decided by the first byte
...
#define HAL_DMA_TRIG_NONE           0   // No trigger, setting DMAREQ.HAL_DMAREQx bit starts transfer
...
#define HAL_DMA_ARM_ABORT 0x80
#define HAL_DMA_ARM_CH0 (1<<0)
#define HAL_DMA_ARM_CH1 (1<<1)
#define HAL_DMA_ARM_CH2 (1<<2)
#define HAL_DMA_ARM_CH3 (1<<3)
#define HAL_DMA_ARM_CH4 (1<<4)

#define HAL_DMAIRQ_DMAIF0 (1<<0)
#define HAL_DMAIRQ_DMAIF1 (1<<1)
#define HAL_DMAIRQ_DMAIF2 (1<<2)
#define HAL_DMAIRQ_DMAIF3 (1<<3)
#define HAL_DMAIRQ_DMAIF4 (1<<4)
